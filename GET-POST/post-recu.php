...
Passworld: <?php echo $_POST["passworld"];?><br>
Textarea: <?php echo $_POST["textarea"];?><br>
Pays: <?php echo $_POST["pays"];?><br>
Pays multiples: <?php if (isset($_POST["paysMultiples"])) {
echo "Les pays sélectionnés sont:";
print_r ($_POST["paysMultiples"]);
} else {
echo "aucun pays sélectionné.";
}?><br>
Pays check: <?php if (isset($_POST["paysCheckbox"])) {
echo "Les pays sélectionnés sont:";
print_r ($_POST["paysCheckbox"]);
} else {
echo "aucun pays sélectionné.";
}?><br>
Pays radio: <?php if (isset($_POST["paysRadio"])) {
echo "Le pays sélectionné est:";
echo $_POST["paysRadio"];
} else {
echo "aucun pays sélectionné.";
}?><br>
Pays radio: <?php echo $_POST["hidden"];?><br>
Submit: <?php echo $_POST["bouton"];?><br>
</body>
</html>